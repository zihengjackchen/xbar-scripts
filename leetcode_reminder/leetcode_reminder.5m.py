...
# Change these before using this script
# https://github.com/zihengjackchen/xbar-scripts/blob/main/leetcode/README.md
USERNAME = ""
LEETCODE_SESSION = ""
CSRFTOKEN = ""
...
if not (USERNAME and LEETCODE_SESSION and CSRFTOKEN):
  print("⚠️ Config")
  # You may choose to exit the script here or take other actions.
  exit()
...
if response.status_code != 200:
  print("API ERROR | color=" + color_hard)
  print("---")
  print(f"Status code: {response.status_code} | color="+color_hard)
...
if easter_egg_collected:
  print(f"--Already collected the easter egg")
else:
